  ...
  return (
    ...
    <Card style={{ width: '18rem', marginBottom: '1rem', opacity: isdelete ? '0.7' : '1' }}>
      <Card.Body>
        ...
        <Row className='mt-2'>
          <Col>
                <Button variant="success" className='mx-2' onClick={()=>handleValidate('completed')}><FaCheck /> </Button>
                <Button variant="warning" className='mx-2' onClick={()=>handleValidate('cancelled')}><FaTimes /></Button>
                <Button variant="danger"  className='mx-2'onClick={handleDelete}><FaTrash /></Button>
          </Col>
        </Row>
      </Card.Body>
    </Card>
